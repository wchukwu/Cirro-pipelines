...
if __name__ == "__main__":
    ...
    # Write out to a file
    samplesheet.to_csv("samplesheet.csv", index=None, sep="\t")

    # Add the param for the samplesheet
    ds.add_param("input", "samplesheet.csv")

    # Format the unicycler_args based on mode
    ds.add_param("unicycler_args", f"--mode {ds.params['mode']}"),
    ds.remove_param("mode")
